...
// 4-row group. Five mixed routings additionally scatter the dst rows: 9/9/8/8, two that
// give an expert exactly 2 and exactly 3 rows, and two 88-row routings. The results must be
// identical bit for bit, not merely within tolerance.
//
