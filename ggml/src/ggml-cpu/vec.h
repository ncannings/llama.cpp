...
// Dot products of nc consecutive src0 rows (stride bx) against one activation row y, with
// the per-output accumulation order over n identical to ggml_vec_dot_f32. See vec.cpp.
#define GGML_VEC_DOT_F32_NC 4
